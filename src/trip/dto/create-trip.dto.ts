...
export class CreateTripDto {
  ...
  @ApiPropertyOptional({ description: 'Driver ID', example: '60a1b2c3d4e5f6a7b8c9d0e3' })
  @IsOptional()
  @IsString()
  driverId?: string;
  ...
  @ApiPropertyOptional({ description: 'Payment method ID', example: 'pm_1234567890' })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ description: 'Trip comment', example: 'Great service!' })
  @IsOptional()
  @IsString()
  comment?: string;

  @ApiPropertyOptional({ description: 'Estimated distance in meters', example: 5000 })
  @IsOptional()
  @IsNumber()
  estimatedDistance?: number;

  @ApiPropertyOptional({ description: 'Estimated duration in seconds', example: 1200 })
  @IsOptional()
  @IsNumber()
